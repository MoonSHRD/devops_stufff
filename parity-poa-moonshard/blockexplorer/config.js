...
var config = function () {
  ...
  // Warning! HttpProvide marked as deprecated in web3.js documentation.
  // Used here instead default IpcProvider due to IPC-socket permission issues.
  this.provider = new web3.providers.HttpProvider("http://172.16.0.10:8545")
